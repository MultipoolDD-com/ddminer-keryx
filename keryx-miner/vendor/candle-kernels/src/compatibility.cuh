...
// capability 7.x and higher. Re-enabled (upstream ships it commented out) so the standard kernel
// set compiles down to sm_61 (Pascal / GTX 10xx) — the miner ships ONE binary whose PTX floor must
// cover the oldest supported GPU. CAS-on-the-containing-32-bit-word, the classic cutorch shim:
